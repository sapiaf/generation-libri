INSERT INTO book (name, url_photo, description, copies, price, sold_copies) VALUES('Harry Potter and the Chamber of Secrets', 'https://m.media-amazon.com/images/I/91OINeHnJGL._AC_UF1000,1000_QL80_.jpg', 'The second installment in the Harry Potter series.', 1000000, 19.99, 4);
INSERT INTO book (name, url_photo, description, copies, price, sold_copies) VALUES('Dune', 'https://m.media-amazon.com/images/I/71dwfOuYLCL._AC_UF1000,1000_QL80_.jpg', 'A science fiction novel set in a desert world.', 750000, 24.99, 4);
INSERT INTO book (name, url_photo, description, copies, price, sold_copies) VALUES('The Great Gatsby', 'https://m.media-amazon.com/images/I/71FTb9X6wsL._AC_UF1000,1000_QL80_.jpg', 'A classic novel set in the Roaring Twenties.', 500000, 15.99, 3);
INSERT INTO book (name, url_photo, description, copies, price, sold_copies) VALUES('1984', 'https://www.einaudi.it/content/uploads/2021/01/978880624818HIG.JPG', 'George Orwell''s dystopian masterpiece.', 800000, 20.00, 3);
INSERT INTO book (name, url_photo, description, copies, price, sold_copies) VALUES('To Kill a Mockingbird', 'https://m.media-amazon.com/images/I/81NeMmw4RQL._SL1500_.jpg', 'A novel of racism and injustice.', 4, 18.50, 2);
