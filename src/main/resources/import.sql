...
INSERT INTO book (name, url_photo, description, publisher, date_of_publishing, copies, price, sold_copies) VALUES('The Lord of the Rings', 'http://example.com/images/lotr.jpg', 'J.R.R. Tolkien''s epic fantasy trilogy.', 'Mondadori', 2000, 1200000, 25.99, 5);
INSERT INTO book (name, url_photo, description, publisher, date_of_publishing, copies, price, sold_copies) VALUES('Pride and Prejudice', 'http://example.com/images/pride.jpg', 'Jane Austen''s classic romance novel.', 'Mondadori', 2000, 203, 14.99, 4);
INSERT INTO book (name, url_photo, description, publisher, date_of_publishing, copies, price, sold_copies) VALUES('Moby Dick', 'http://example.com/images/mobydick.jpg', 'Herman Melville''s tale of the white whale.', 'Feltrinelli', 2000, 100, 17.99, 3);
INSERT INTO book (name, url_photo, description, publisher, date_of_publishing, copies, price, sold_copies) VALUES('Brave New World', 'http://example.com/images/bravenewworld.jpg', 'Aldous Huxley''s vision of a future dystopia.', 'La Terza', 2000, 700000, 19.50, 4);
INSERT INTO book (name, url_photo, description, publisher, date_of_publishing, copies, price, sold_copies) VALUES('The Catcher in the Rye', 'http://example.com/images/catcher.jpg', 'J.D. Salinger''s novel of teenage angst.', 'Mondadori', 2000, 550000, 18.99, 3);
INSERT INTO book (name, url_photo, description, publisher, date_of_publishing, copies, price, sold_copies) VALUES('War and Peace', 'http://example.com/images/warandpeace.jpg', 'Leo Tolstoy''s epic tale of Russia during the Napoleonic Wars.', 'Mondadori', 2000, 300000, 27.99, 2);
INSERT INTO book (name, url_photo, description, publisher, date_of_publishing, copies, price, sold_copies) VALUES('The Odyssey', 'http://example.com/images/odyssey.jpg', 'Homer''s ancient Greek epic poem.', 'La Terza', 2005, 9, 16.99, 3);
INSERT INTO book (name, url_photo, description, publisher, date_of_publishing, copies, price, sold_copies) VALUES('Crime and Punishment', 'http://example.com/images/crime.jpg', 'Fyodor Dostoevsky''s exploration of morality and redemption.', 'Feltrinelli', 1800, 500000, 19.99, 4);
INSERT INTO book (name, url_photo, description, publisher, date_of_publishing, copies, price, sold_copies) VALUES('The Brothers Karamazov', 'http://example.com/images/brothersk.jpg', 'Dostoevsky''s philosophical novel on faith, doubt, and morality.', 'Mondadori', 2007, 480000, 21.99, 3);
INSERT INTO book (name, url_photo, description, publisher, date_of_publishing, copies, price, sold_copies) VALUES('Anna Karenina', 'http://example.com/images/anna.jpg', 'Tolstoy''s novel of love and society in Tsarist Russia.', 'Mondadori', 1997, 520000, 20.50, 4);
